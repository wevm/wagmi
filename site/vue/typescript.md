...
By default Vue plugins do not work well with type inference. To support strong type-safety across the Vue plugin boundary, there are two options available:

  ...
  <div mt-4 flex flex-col gap-2>
    ...
    <div flex flex-wrap mb-1 gap-1.5 items-center>
      <a :href="`https://npm.im/${props.package}`" class="link">
        <svg size-4 viewBox="0 0 16 16"><title>n</title><path fill="#c12127" d="M0,16V0H16V16ZM3,3V13H8V5h3v8h2V3Z"/><path fill="#fff" d="M3,3H13V13H11V5H8v8H3Z"/></svg>
        <span>npm</span>
      </a>
      ...
      <a v-else :href="props.licenseUrl" class="link">
        ...
        <span>Non-OSI Approved License</span>
      </a>
    </div>
  </div>
</template>

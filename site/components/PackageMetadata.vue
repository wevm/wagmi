...
<template>
  <code v-if="props.showName" text-sm>
    {{props.package}}
  </code>
  <div flex my-2 gap-1.5 items-center>
    ...
    <a v-if="props.osiLicense" :href="`https://opensource.org/license/${props.osiLicense}`" class="link">

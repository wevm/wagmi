...
const redirects: Record<string, string> = {
  ...
  '/docs/core/actions/fetchSigner': '/docs/core/actions/getWalletClient',
  '/docs/core/actions/getProvider': '/docs/core/actions/getPublicClient',
  '/docs/core/actions/getWebSocketProvider':
    '/docs/core/actions/getWebSocketPublicClient',

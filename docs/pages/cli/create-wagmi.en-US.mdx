...
- `vite-react-cli-abi`: A Vite (React) wagmi project with `@wagmi/cli` set up
- `vite-react-cli-erc`: A Vite (React) project with `@wagmi/cli` ERC Plugin set up
- `vite-react-cli-etherscan`: A Vite (React) wagmi project with `@wagmi/cli` Etherscan Plugin set up
- `vite-react-cli-foundry`: A Vite (React) wagmi project with `@wagmi/cli` Foundry Plugin set up

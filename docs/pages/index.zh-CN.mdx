...
在这个例子中，我们创建了一个 wagmi client，并将其传递给 `WagmiConfig` 这一 React context。client 使用了 ethers 的默认 Provider，并自动连接到之前连接的钱包。
...
- 分享你的 [使用 wagmi 的项目/组织](https://github.com/wagmi-dev/wagmi/discussions/201)

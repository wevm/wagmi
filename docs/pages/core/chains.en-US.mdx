...
The `@wagmi/core/chains` entrypoint proxies the [`viem/chains` entrypoint](https://viem.sh/docs/clients/chains.html#chains), an official wagmi package which contains references to popular EVM-compatible chains such as: Polygon, Optimism, Avalanche, and more.

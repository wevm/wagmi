...
<Callout type="warning">
  ...
  is loaded in the Safe Context. Autoconnect logic may be implemented
  separately. If you're using react, you can find an example hook in [React
  docs](/react/connectors/safe)
</Callout>

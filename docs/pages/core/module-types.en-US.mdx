...
In the best interest of moving wagmi forward and aligning with the future of the web, `@wagmi/core` is a [pure ESM module](https://gist.github.com/sindresorhus/a39789f98801d908bbc7ff3ecc99d99c) by default for a number of reasons:
...
<Tabs items={['npm', 'pnpm', 'yarn']}>
  ...
  <Tab>
    ```bash 
    pnpm i @wagmi/core@cjs 
    ```
  </Tab>
  <Tab>
    ```bash 
    yarn add @wagmi/core@cjs 
    ```
  </Tab>
</Tabs>
{/* prettier-ignore-end */}

...
description: "The configureChains function allows you to configure your chains with RPC Providers such as: Alchemy, Infura, or something else. This means you don't need to worry about defining RPC URLs and chain configuration in your connector or provider. This is managed internally by wagmi."
---
...
`configureChains` accepts an array of [chains](/core/chains) and an array of RPC Provider. It returns:

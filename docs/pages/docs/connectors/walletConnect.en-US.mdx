...
Note: Upon connection, the connector will connect to the first chain in the array unless otherwise specified by a [`chainId` config on useConnect](/docs/hooks/useConnect#chainid-optional).

...
Want to learn more? Check out the [examples](/examples/connect-wallet) to learn how to use wagmi in real-world situations or continue on reading the documentation.

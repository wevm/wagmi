...
Next, wrap your app with the [`ClientProvider`](/docs/ClientProvider) component, passing `client` to it.
...
Finally, use hooks! Every component inside the `ClientProvider` is now set up to use the wagmi hooks.

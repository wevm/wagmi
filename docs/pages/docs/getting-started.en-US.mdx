...
Note: In a production app, it is not recommended to only pass `publicProvider` to `configureChains` as you will probably face rate-limiting on the public provider endpoints. It is recommended to also pass an [`alchemyProvider`](/docs/providers/alchemy), [`coinbaseNodeProvider`](/docs/providers/coinbaseNode) or [`infuraProvider`](/docs/providers/infura) as well.

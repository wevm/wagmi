...
Hook for declaratively waiting until transaction is processed. Pairs well with [`useContractWriteLazy`](/docs/hooks/useContractWriteLazy)/[`useContractWriteEager`](/docs/hooks/useContractWriteEager) and [`useSendTransaction`](/docs/hooks/useSendTransaction).
...
Transaction hash to monitor. Works well with [`useContractWriteLazy`](/docs/hooks/useContractWriteLazy)/[`useContractWriteEager`](/docs/hooks/useContractWriteEager) and [`useSendTransaction`](/docs/hooks/useSendTransaction) `data.hash`.

```tsx {5}
import { useContractWriteEager, useWaitForTransaction } from 'wagmi'

function App() {
  const contractWrite = useContractWriteEager({
...
Function that resolves to processed transaction receipt. Works well with [`useContractWriteLazy`](/docs/hooks/useContractWriteLazy)/[`useContractWriteEager`](/docs/hooks/useContractWriteEager) and [`useSendTransaction`](/docs/hooks/useSendTransaction) `data.wait`.

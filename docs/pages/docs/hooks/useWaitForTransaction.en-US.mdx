...
Transaction hash to monitor. Works well with [`useContractWrite`](/docs/hooks/useContractWrite)/[`useContractWritePrepared`](/docs/hooks/useContractWritePrepared) and [`useSendTransaction`](/docs/hooks/useSendTransaction) `data.hash`.
...
Function that resolves to processed transaction receipt. Works well with [`useContractWrite`](/docs/hooks/useContractWrite)/[`useContractWritePrepared`](/docs/hooks/useContractWritePrepared) and [`useSendTransaction`](/docs/hooks/useSendTransaction) `data.wait`.

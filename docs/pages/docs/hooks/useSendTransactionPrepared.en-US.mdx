...
Hook for sending a transaction with a ["prepared request"](/TODO). Pairs with the [`usePrepareTransaction` hook](/TODO).
...
The prepared request to use when sending the transaction. Derived from the [`usePrepareTransaction` hook](/TODO).

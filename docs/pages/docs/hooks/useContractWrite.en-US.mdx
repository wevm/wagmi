...
<Callout emoji="⚠️">
  It is recommended to pair this with the [`useContractWritePrepare`
  hook](/docs/hooks/useContractWritePrepare) to [avoid a harmful UX](/TODO).
</Callout>

Hook for calling an ethers Contract [write](https://docs.ethers.io/v5/api/contract/contract/#Contract--write) method with a ["prepared request"](/TODO). Pairs with the [`useContractWritePrepare` hook](/docs/hooks/useContractWritePrepare).

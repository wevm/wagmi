...
<Callout>
  ...
  [`useContractWriteLazy`](/docs/hooks/useContractWriteLazy)/[`useContractWritePrepared`](/docs/hooks/useContractWritePrepared)
  instead of imperatively calling the function.
</Callout>

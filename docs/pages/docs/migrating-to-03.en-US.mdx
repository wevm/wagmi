...
If you are coming from an earlier version of `wagmi`, in order to update to `0.3.x`, you will need to make sure to update the following hooks & API's listed below.

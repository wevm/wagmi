...
Connecting wallets to your app is extremely simple when you use wagmi. It takes less than five minutes to get up and running with MetaMask, Tally, WalletConnect, and Coinbase Wallet!
...
First, we want to set up our [`Provider`](/docs/provider) with the Injected (MetaMask, Tally), WalletConnect, and WalletLink (Coinbase Wallet) connectors:

...
wagmi has built-in wallet connectors for [Injected](/docs/connectors/injected) (i.e. MetaMask), [WalletConnect](/docs/connectors/walletConnect) (i.e. Rainbow), and [WalletLink](/docs/connectors/walletLink) (Coinbase Wallet). Tens of millions of users are supported by these options and they are very fast to set up!

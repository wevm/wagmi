...
It is recommended for projects to [migrate](/react/migration-guide) to [viem](https://viem.sh) when using wagmi, but there are some cases where you might still need to use [ethers.js](https://ethers.org/) in your project:

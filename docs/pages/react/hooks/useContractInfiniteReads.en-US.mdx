...
```tsx
import { useContractInfiniteReads } from 'wagmi-react'
```
...
```tsx
import { BigNumber } from 'ethers'
import { useContractInfiniteReads, paginatedIndexesConfig } from 'wagmi-react'
import mlootABI from './mlootABI.json'
...
import { optimism } from 'wagmi-react/chains'
import { BigNumber } from 'ethers'

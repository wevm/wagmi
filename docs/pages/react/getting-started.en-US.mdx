...
```tsx
import { configureChains, mainnet } from 'wagmi-react'
...
```tsx {9-13}
import { WagmiConfig, createClient, configureChains, mainnet } from 'wagmi-react'
import { publicProvider } from 'wagmi/providers/public'
...
```tsx {5,6,7-9}
import { useAccount, useConnect, useEnsName } from 'wagmi-react'

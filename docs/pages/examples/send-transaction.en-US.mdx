...
Create a new component and add the [`usePrepareSendTransaction` hook](/docs/hooks/usePrepareSendTransaction). This hook eagerly fetches the parameters required for sending a transaction such as the gas estimate.

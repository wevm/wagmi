...
```tsx
import { Chain, Provider, chain, createClient } from 'wagmi'
...
// Configure chains & providers with the Alchemy API provider.
// Two popular API providers are Alchemy (alchemy.com) and Infura (infura.io)

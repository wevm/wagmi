...
Yes. Wagmi is very stable and is used in production by thousands of organizations, like [ENS](https://ens.domains), [Stripe](https://stripe.com), and [Shopify](https://shopify.com).

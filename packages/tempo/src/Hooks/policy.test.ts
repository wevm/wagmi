...
import { accounts, config, queryClient, renderHook } from '../../test/config.js'
...
describe('useCreate', () => {
  test('default', async () => {
    ...
    const data = await policyActions.getData(config, {
      policyId,
    })
...
describe('useSetAdmin', () => {
  test('default', async () => {
    ...
    {
      // verify new admin
      const data = await policyActions.getData(config, { policyId })
...
describe('useModifyWhitelist', () => {
  test('default', async () => {
    ...
    {
      const isAuthorized = await policyActions.isAuthorized(config, {
        policyId,
...
describe('useGetData', () => {
  ...
  describe('queryOptions', () => {
    test('default', async () => {
      ...
      const options = policyActions.getData.queryOptions(config, { policyId })
...
describe('useIsAuthorized', () => {
  ...
  describe('queryOptions', () => {
    test('default', async () => {
      const options = policyActions.isAuthorized.queryOptions(config, {
        policyId: 1n,
        user: account.address,
      })

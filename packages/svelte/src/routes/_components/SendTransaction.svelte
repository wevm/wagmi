...
import { useSendTransaction } from '$lib/hooks/useSendTransaction.svelte.js'
import { useWaitForTransactionReceipt } from '$lib/hooks/useWaitForTransactionReceipt.svelte.js'

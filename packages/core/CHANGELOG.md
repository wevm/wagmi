...
- [#1203](https://github.com/wagmi-dev/wagmi/pull/1203) [`bb5b7b10`](https://github.com/wagmi-dev/wagmi/commit/bb5b7b1027f5612f4dd51d2033983dea8dd3d573) Thanks [@tmm](https://github.com/tmm)! - **Breaking**: `addressOrName` renamed to `address` for `fetchBalance` and `fetchEnsAvatar`.

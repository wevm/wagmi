...
export type DeprecatedWriteContractResult = providers.TransactionResponse

export async function deprecatedWriteContract<
...
>({
  ...
  overrides,
  signerOrProvider,
}: DeprecatedWriteContractConfig): Promise<DeprecatedWriteContractResult> {

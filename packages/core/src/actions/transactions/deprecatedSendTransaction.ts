...
export type DeprecatedSendTransactionArgs = {
  /**
...
export type DeprecatedSendTransactionResult = providers.TransactionResponse

export async function deprecatedSendTransaction({
  chainId,
  request,
}: DeprecatedSendTransactionArgs): Promise<DeprecatedSendTransactionResult> {

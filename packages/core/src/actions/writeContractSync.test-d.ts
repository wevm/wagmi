...
test('simulateContract', async () => {
  ...
  await writeContractSync(config, request)
  await writeContractSync(config, {
    address: '0x',
    abi: abi.erc20,
    functionName: 'transferFrom',
...
test('chain formatters', () => {
  ...
  type Result2 = WriteContractSyncParameters<
    typeof abi.erc20,
    'transferFrom',
    [Address, Address, bigint],
    typeof config,
  ...
  type Result3 = WriteContractSyncParameters<
    typeof abi.erc20,
    'transferFrom',
    [Address, Address, bigint],
    typeof config,
...
test('overloads', async () => {
  ...
  type Result = WriteContractSyncParameters<typeof abi, 'foo'>
  ...
  type Result2 = WriteContractSyncParameters<typeof abi, 'bar'>

...
test('chain formatters', () => {
  ...
  if (data && data.chainId === celo.id) {
    ...
    expectTypeOf(data.gatewayFee).toEqualTypeOf<bigint | undefined>()
    expectTypeOf(data.gatewayFeeRecipient).toEqualTypeOf<
      `0x${string}` | undefined
    >()
  }
  ...
  if (data2) {
    ...
    expectTypeOf(data2.gatewayFee).toEqualTypeOf<bigint | undefined>()
    expectTypeOf(data2.gatewayFeeRecipient).toEqualTypeOf<
      `0x${string}` | undefined
    >()
  }
